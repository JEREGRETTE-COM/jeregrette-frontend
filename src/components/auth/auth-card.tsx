...
export function AuthCard({
  ...
  return (
    <div className="border-surface-border bg-surface relative flex w-full max-w-[520px] flex-col overflow-hidden rounded-[25px] border-y-[3px] px-5 sm:min-h-[705px] sm:px-6">
      <Link
        href="/"
        aria-label="Fermer"
